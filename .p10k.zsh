# Generated by Powerlevel10k configuration wizard on 2020-11-28 at 20:32 EET.
...
() {
  ...
  # Left segment customizations.
  typeset -g POWERLEVEL9K_USER_DEFAULT_BACKGROUND=black
  ...
  typeset -g POWERLEVEL9K_NODEENV_BACKGROUND=blue
  typeset -g POWERLEVEL9K_NODEENV_FOREGROUND=black
